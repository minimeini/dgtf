...
#'
#' @format A [`dgtf_sim`][dgtf_simulate_model] object, that is, a list
#'   holding the numeric vector of observations `y` together with `psi`,
#'   `lambda`, `ft`, `Theta`, `nlag`, and the originating `model` and
#'   `gain`.
