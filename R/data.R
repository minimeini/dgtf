...
#' @source Generated by `data-raw/sim_hawkes.R` with seed 1.
#' @keywords datasets
"sim_hawkes"
...
#' County, California from July 2, 2020 through December 1, 2021.
#'
#' @format A numeric vector of length N.   # <-- fill in N
#' @source <publisher name and URL, e.g. California Department of
#'   Public Health, https://...>. Prep script:
#'   `data-raw/covid_scz_2020.R`.
#' @keywords datasets
"covid_scz_2020"